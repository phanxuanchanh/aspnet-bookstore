...
namespace CuaHangSach.Controllers
{
    ...
    public class AccountController : Controller
    {
       ...
       [Route("login")]
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            try
            {
                ...
                if (signedUser == null)
                {
                    ModelState.AddModelError("", "Không tìm thấy người dùng có tài khoản Email này!");
                    return View(model);
                }
            ...
            {
                return View("Error", model: $"Lỗi: {ex.Message}");
            }
        }
       ...
       [Route("register")]
        ...
        {
            ViewBag.SiteName = "Đăng ký tài khoản";
            return View();
        }
